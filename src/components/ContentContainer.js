  ...
  return (
    <div className="content-container">
      ...
      <div className="content-list">
        ...
        <Post name="Ellie" timestamp="4 days ago" text={`Lorem ipsum dolor sit amet consectetur adipisicing elit. `} />
        <Post
          name="Chris"
...
const PlusIcon = () => {
  return <BsPlusCircleFill size="22" className="text-green-500 mx-2" />;
};
